...
class Menu extends StatelessWidget {
  ...
  const Menu({Key key, this.slideAnimation, this.menuAnimation}) : super(key: key);
  @override
        ...
        child: Padding(
          ...
          child: Align(
            ...
            child: Column(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: (){ BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.DashboardClickedEvent);},
                ...
                GestureDetector(
                  onTap: (){
                    ...
                    child: Text("Messages", style: TextStyle(color: Colors.white, fontSize: 22))),
                SizedBox(height: 30),
                GestureDetector(
                  onTap: (){
                    BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.UtilityClickedEvent);
                  },
                    child: Text("Utility Bills", style: TextStyle(color: Colors.white, fontSize: 22))),
                SizedBox(height: 30),
